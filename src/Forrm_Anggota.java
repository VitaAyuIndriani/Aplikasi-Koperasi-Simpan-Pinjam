 ...
 * E31191821
 */
public class Forrm_Anggota extends javax.swing.JFrame {
    public Forrm_Anggota() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setFont(new java.awt.Font("Century751 BT", 0, 12)); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Forrm_Anggota.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Forrm_Anggota().setVisible(true);
            }
        });
    }
...
public class koneksi{
    public koneksi(){
        ...
        try{
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost/Mahasiswa", "root", "password");
            return con;
        }
